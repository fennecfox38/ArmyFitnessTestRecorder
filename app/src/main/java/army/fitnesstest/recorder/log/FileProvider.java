...
public class FileProvider extends androidx.core.content.FileProvider {
    ...
    public static final String AUTHORITY = "army.fitnesstest.recorder.log.FileProvider";
    ...
    public static Uri getDatabaseUri(Context context) {
        return getUriForFile(context, context.getPackageName()+".log.FileProvider", getDBFile(context));
    }
    public static Uri getXLSUri(Context context) {
        return getUriForFile(context, context.getPackageName()+".log.FileProvider", getXLSFile(context));
    }
}
