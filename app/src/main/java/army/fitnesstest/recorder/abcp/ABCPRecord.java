...
import army.fitnesstest.recorder.Standard;

import static army.fitnesstest.recorder.log.ABCPDBHelper.DBContract.*;
...
public class ABCPRecord {
    ...
    public boolean height_weight = false, bodyFatPass = true, isPassed = false;
